...
#define MESSAGE_DETAILS \
	Dialog::tr("If a message box have a detailed text, the user can reveal it " \
...
DialogOptionsWidget::DialogOptionsWidget( QWidget* parent /*= 0*/ )
...
void Dialog::warningMessage()
{
	...
	msgBox.addButton(tr("&Continure"), QMessageBox::RejectRole);
