...
ClassInfoPage::ClassInfoPage( QWidget* parent /*= 0*/ )
	: QWizardPage(parent)
{
...
CodeStylePage::CodeStylePage( QWidget* parent /*= 0*/ )
	: QWizardPage(parent)
{
	...
	includeBaseCheckBox = new QCheckBox(tr("&Include base class defination"));
...
OutputFilesPage::OutputFilesPage( QWidget* parent /*= 0*/ )
	: QWizardPage(parent)
{
