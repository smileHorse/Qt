...
EvaluatePage::EvaluatePage( QWidget* parent /*= 0*/ )
	: QWizardPage(parent)
{
	...
	emailLabel = new QLabel(tr("&Eamil address:"));
...
RegisterPage::RegisterPage( QWidget* parent /*= 0*/ )
	: QWizardPage(parent)
{
